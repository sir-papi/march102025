...
% cd vscode101
git add .
git commit -m "new dir for cs50"
git push
% cd 13march2025
git add .
git commit -m "file maintenance. new code for random pwd"
...
...
- [x] :trophy: fcc project: tribute page;
  - [x] ~who? old uzi~ `/Users/apple/vscode101/old coda/hero.html` 
...
`/Users/apple/Documents/13march2025/freecodecamp/cat painting/coleman.html`  
  - [x] :trophy: next challenge: :musical_keyboard: fcc (project)
